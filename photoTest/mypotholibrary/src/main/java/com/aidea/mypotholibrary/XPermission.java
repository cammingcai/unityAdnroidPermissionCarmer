...
//                AppCompatActivity.requestPermissions(deniedPermissions
...
//        }
    ...
    public static void showTipsDialog(final Activity context) {
        ...
        new AlertDialog.Builder(context)
                .setTitle("提示信息")
                .setMessage("当前缺少必要权限，该功能暂时无法使用。如若需要，请单击【确定】按钮前往设置中心进行权限授权。")
    ...
    public static void showTipsDialog(final Activity context, String tips) {
        new AlertDialog.Builder(context)
                .setTitle("提示信息")
                .setMessage(tips)
                .setNegativeButton("取消", null)
